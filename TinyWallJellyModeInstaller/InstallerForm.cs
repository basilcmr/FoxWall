...
namespace TinyWallJellyModeInstaller
{
    public class InstallerForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "FoxWall Jelly Mode Setup (v1.2.11)";
            ...
            {
                Text = "FoxWall Custom Setup (v1.2.11)",
            ...
            {
                Text = "Install or completely remove the custom-themed FoxWall Jelly Mode config (v1.2.11).",
        ...
        private async Task StartInstall()
        {
            ...
            logTextBox.Clear();
            AppendLog("Starting custom FoxWall 1.2.11 installation...");
